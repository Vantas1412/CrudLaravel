										...
										<td >{{ $proveedor->codigo_producto }}</td>
                                            ...
                                            <td>
                                                <form action="{{ route('proveedors.destroy', $proveedor->codigo_proveedor) }}" method="POST">
                                                    <a class="btn btn-sm btn-primary " href="{{ route('proveedors.show', $proveedor->codigo_proveedor) }}"><i class="fa fa-fw fa-eye"></i> {{ __('Show') }}</a>
                                                    <a class="btn btn-sm btn-success" href="{{ route('proveedors.edit', $proveedor->codigo_proveedor) }}"><i class="fa fa-fw fa-edit"></i> {{ __('Edit') }}</a>
                                                    @csrf
                                                    @method('DELETE')
